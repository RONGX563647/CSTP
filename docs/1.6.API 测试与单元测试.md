...
├─────────────────────────────────────────────────────────┤
│  前置准备：                                               │
│  - 清理并初始化测试数据（DataInitializer）              │
│  - 三个测试账号登录获取 session                           │
│  - 提前完成部分订单到 PENDING_REVIEW 状态                 │
├─────────────────────────────────────────────────────────┤
│  测试分组：                                               │
│  1. 健康检查 (1 个)                                       │
│  2. 认证相关 (5 个) - 注册、登录、登出、当前用户           │
│  3. 用户管理 (5 个) - 信息修改、密码修改、头像上传         │
│  4. 商品相关 (12 个) - CRUD、上架下架、图片上传            │
│  5. 订单相关 (20 个) - 创建、付款、提货、确认、取消、评价   │
│  6. 地址相关 (10 个) - CRUD、默认地址设置                  │
│  7. 分类相关 (4 个) - 列表、树形结构                       │
│  8. 管理后台 (5 个) - 用户/商品/订单管理                   │
└─────────────────────────────────────────────────────────┘
```
